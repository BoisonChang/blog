...
這篇文章會拆解該要如何在 5 分鐘內快速架設一個靜態網站的步驟，首先你可以利用 Hugo 這套工具產生你的網站架構，並且利用 Nelify 將網頁部署在 Github Pages，若是過去完全沒有寫程式的經驗，你會需要根據注意事項花額外的時間準備好一些基礎建設並適度了解其原理 (套件管理工具 Homebrew、程式碼代管平台 GitHub、Netlify 靜態網站託管平台)。
